<section class='filled card'>
    ...
    <div class='card-body'>
        <a href='<?php echo base_url.'productlike/'.$product['id']; ?>'><i class='<?php echo $iconclassheart; ?> fa-heart'></i></a>
        <a href='<?php echo base_url.'productbookmark/'.$product['id']; ?>'><i class='<?php echo $iconclassbookmark; ?> fa-bookmark'></i></a>
        <h5 class='card-title'><a href='<?php echo base_url.'product/'.$product['id']; ?>'><?php echo $product['name']; ?></a></h5>
